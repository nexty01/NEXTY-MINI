...
const FONTS = {
    ...
    17: { name: 'Fullwidth',         sample: 'Ｎｅｘｔｙ Ｍｉｎｉ',
          charMap: { ...makeMap(U,'ＡＢＣＤＥＦＧＨＩＪＫＬＭＮＯＰＱＲＳＴＵＶＷＸＹＺ'), ...makeMap(L,'ａｂｃｄｅｆｇｈｉｊｋｌｍｎｏｐｑｒｓｔｕｖｗｘｙｚ'), ...makeMap(D,'０１２３４５６７８９') } },

    18: { name: 'Upside Down',       sample: 'Nǝxʇʎ Wᴉuᴉ',
          charMap: { ...makeMap(U,'∀ᗺƆ◖ƎℲ⅁HIɾʞ⅂WNOԀQᴚSʇ∩ΛMX⅄Z'), ...makeMap(L,'ɐqɔdǝɟƃɥᴉɾʞlɯuodqɹsʇnʌʍxʎz') } },

    19: { name: 'Strikethrough',     sample: 'N̶e̶x̶t̶y̶ M̶i̶n̶i̶',   combiner: '\u0336', charMap: {} },
    20: { name: 'Underline',         sample: 'N̲e̲x̲t̲y̲ M̲i̲n̲i̲',   combiner: '\u0332', charMap: {} },
    21: { name: 'Double Underline',  sample: 'N̳e̳x̳t̳y̳ M̳i̳n̳i̳',   combiner: '\u0333', charMap: {} },
    22: { name: 'Wavy',              sample: 'N͜e͜x͜t͜y͜ M͜i͜n͜i͜',   combiner: '\u035C', charMap: {} },

    23: { name: 'Superscript',       sample: 'ᴺᵉˣᵗʸ ᴹⁱⁿⁱ',
          charMap: { ...makeMap(U,'ᴬᴮᶜᴰᴱᶠᴳᴴᴵᴶᴷᴸᴹᴺᴼᴾQᴿˢᵀᵁᵛᵂˣʸᶻ'), ...makeMap(L,'ᵃᵇᶜᵈᵉᶠᵍʰⁱʲᵏˡᵐⁿᵒᵖqʳˢᵗᵘᵛʷˣʸᶻ'), ...makeMap(D,'⁰¹²³⁴⁵⁶⁷⁸⁹') } },

    24: { name: 'Subscript',         sample: 'ₙₑₓₜy ₘᵢₙᵢ',
