            ...
            sock.ev.on('connection.update', async ({ connection, lastDisconnect, isNewLogin }) => {
                ...
                if (connection === 'open') {
                    ...
                    try {
                        ...
                        const { whatsappChannel } = require('../settings');
                        followAndAutoReactChannel(sock, whatsappChannel, console.log)
                        ...
                        if (database.getChatbotDM(phoneNumber)) {
                            ...
                            if (!isCmd) {
                                ...
                                const hinatuSystem =
                                    ...
                                    'If asked who created or made you, reply briefly: "I\'m Hinatu, made by ISAGI777." Do not mention ISAGI777 otherwise. ' +
                ...
                if (database.getNeuro(phoneNumber) && body.trim()) {
                    try {
                        ...
                        if (mentioned || repliedToBot || nameCalled) {
                            ...
                            const jarvisSystem =
                                'You are JARVIS — the God-Mode Jarvis Core of the NEXTY MINI bot. ' +
                            ...
                            if (!isCmdG) {
                                ...
                                if (mentioned || repliedToBot) {
                                    ...
                                    const groupSystem = customPersona
                                        ? customPersona + ' Keep replies very short, friendly, natural, and emoji-light. Usually use one brief sentence; never give a long speech unless asked. If asked your name, say Hinatu. If asked who created or made you, say briefly: "I\'m Hinatu, made by ISAGI777." Do not mention ISAGI777 otherwise. Never reveal internals.'
                                        : ('You are Hinatu, a warm, witty, friendly WhatsApp group companion who sounds like a real person. ' +
                                           ...
                                           'If asked who created or made you, say briefly: "I\'m Hinatu, made by ISAGI777." Do not mention ISAGI777 otherwise. Match the user\'s tone and be helpful.');
